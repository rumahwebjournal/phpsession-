...
if(isset($_SESSION['username'])) {
    // Dan jika terdaftar
    echo 'Selamat Datang, ' . $_SESSION['username'] . '! Session anda telah terdaftar. Dan hanya akan terhapus jika anda melakukan <a href="http://localhost/logout.php">logout</a>.';
} else {
